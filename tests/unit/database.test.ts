...
describe("database", () => {
  ...
  it("creates all data tables via migrations", () => {
    ...
    expect(tableNames).toEqual(["activity_events", "contacts", "contacts_search", "interactions", "knowledge_chunks", "knowledge_sources", "personas", "project_details", "project_history", "project_plan_items", "projects_index", "shared_artifacts", "task_state", "tasks"]);
  });
