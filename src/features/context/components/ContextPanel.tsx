            ...
            {CONTEXT_TAB_CONFIG.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative inline-flex flex-shrink-0 items-center justify-center min-h-[44px] lg:h-7 px-3 ${sectionLabelClass} transition-all duration-150 focus-ring rounded-full ${
                    isActive
