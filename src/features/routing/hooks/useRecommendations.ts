  ...
  for (const [model, breakdown] of costByModel) {
    ...
    if (cronSessions > 0) {
      ...
      points.push({
        ...
        count: Math.round(breakdown.sessions * cronRatio),
        totalCostUsd: breakdown.totalCost * cronRatio,
      });
    }
    ...
    if (heartbeatRatio > 0) {
      points.push({
        ...
        count: Math.max(1, Math.round(breakdown.sessions * heartbeatRatio)),
        totalCostUsd: breakdown.totalCost * heartbeatRatio,
      });
    }
    ...
    if (mainRatio > 0) {
      points.push({
        ...
        count: Math.max(1, Math.round(breakdown.sessions * mainRatio)),
        totalCostUsd: breakdown.totalCost * mainRatio,
      });
    }
  }
