...
export const AgentStudioPage = () => {
  ...
  const chatPanelProps = focusedAgent ? {
    ...
    sessionView: {
      ...
      history: viewingSessionHistory,
      loading: viewingSessionLoading,
      error: viewingSessionError,
      onRetry: retryTranscript,
      onExit: stableChatOnExitSessionView,
    },
    ...
    wizardProps: {
      ...
      onDismissResult: clearWizardCreationResult,
