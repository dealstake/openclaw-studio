...
export const FloatingMobileHeader = memo(function FloatingMobileHeader({
  ...
  return (
    <div
      className={`fixed top-0 inset-x-0 z-[var(--z-header)] flex items-center justify-between px-4 py-3 lg:hidden transform-gpu transition-all duration-300 ease-in-out ${
        visible
