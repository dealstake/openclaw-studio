...
export const PanelIconButton = React.memo(function PanelIconButton({
  ...
  return (
    <button
      type="button"
      className={`flex min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 sm:h-7 sm:w-7 items-center justify-center rounded-md border transition active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-60 focus-ring ${variantClasses[variant]} ${className}`}
